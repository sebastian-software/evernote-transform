...
module.exports = {
  ...
  // JSON Sort Plugin: Sort the whole file, not just top-level keys
  jsonRecursiveSort: true,

  // The main reason why we use `.js` for the config file:
  // stable resolve for different contexts in PNPM Workspaces Repo
